...
### [Custom Tools](https://ai-sdk.dev/docs/foundations/tools\#custom-tools)
...
11    return { temperature: 72, conditions: 'sunny' };
...
### [Provider-Defined Tools](https://ai-sdk.dev/docs/foundations/tools\#provider-defined-tools)
...
7    bash: anthropic.tools.bash_20250124({

8      execute: async ({ command }) => {

9        // Your implementation to run the command

10        return runCommand(command);
...
14  prompt: 'List files in the current directory',
...
### [Provider-Executed Tools](https://ai-sdk.dev/docs/foundations/tools\#provider-executed-tools)
...
9  prompt: 'What happened in the news today?',
...
### [Comparison](https://ai-sdk.dev/docs/foundations/tools\#comparison)
...
page. See [Anthropic Provider](https://ai-sdk.dev/providers/ai-sdk-providers/anthropic) and
[OpenAI Provider](https://ai-sdk.dev/providers/ai-sdk-providers/openai) for examples.
...
4export const myTool = tool({

5  description: 'A helpful tool',
...
and [Agents](https://ai-sdk.dev/docs/agents) documentation has more information about tools and tool calling.
